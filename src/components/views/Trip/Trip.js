...
const Trip = ({error, name, image, cost, days, description, country, intro, match}) => {
      ...
      <Grid>
        <Row>
          <Col xs={12}>
            ...
            <OrderForm tripCost={cost} tripId={match.params.id} tripName={name} tripCountryCode={country.alpha3Code} />
          </Col>
        </Row>
      </Grid>
    </Section>
